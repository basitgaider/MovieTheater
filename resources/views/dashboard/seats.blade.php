...
<body>
    <div class="container-fluid position-relative d-flex p-0">
        ...
        <div class="content">
            ...
            <h2 class="mb-4">Seats Creation</h2>
            <form action="/seat_creation" method="POST" enctype="multipart/form-data">

                <h5><label for="Cinemas">Cinemas</label></h5>
                <select name="Cinema[]" id="cinemas" multiple>
                    @foreach($cinemas as $cinema)
                    <option value="{{ $cinema->id }}">{{ $cinema->Theatre_name }}</option>
                    @endforeach
                </select><br>
                ...
                <h5><label for="Cinemas">Class</label></h5>
                ...
                <div class="row mb-3">
                    <label class="col-sm-2 col-form-label">Seat Number</label>
                    <div class="col-sm-10">
