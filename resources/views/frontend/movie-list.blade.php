                                ...
                                <div class="row mb-10 justify-content-center">
                                    ...
                                    <div class="col-sm-6 col-lg-4">
                                        <div class="movie-grid">
                                            ...
                                            <div class="movie-content bg-one">
                                                <h5 class="title m-0">
                                                    <a href="moviedetail">horror night</a>
                                                </h5>
                                                <ul class="movie-rating-percent">
                                                    <li>
                                                        <div class="thumb">
                                    ...
                                    <div class="col-sm-6 col-lg-4">
                                        <div class="movie-grid">
                                            ...
                                            <div class="movie-content bg-one">
                                                <h5 class="title m-0">
                                                    <a href="moviedetail">the lost name</a>
                                                </h5>
                                                <ul class="movie-rating-percent">
                                                    <li>
                                                        <div class="thumb">
                                    ...
                                    <div class="col-sm-6 col-lg-4">
                                        <div class="movie-grid">
                                            ...
                                            <div class="movie-content bg-one">
                                                <h5 class="title m-0">
                                                    <a href="moviedetail">calm stedfast</a>
                                                </h5>
                                                <ul class="movie-rating-percent">
                                                    <li>
                                                        <div class="thumb">
                                    ...
                                    <div class="col-sm-6 col-lg-4">
                                        <div class="movie-grid">
                                            ...
                                            <div class="movie-content bg-one">
                                                <h5 class="title m-0">
                                                    <a href="moviedetail">criminal on party</a>
                                                </h5>
                                                <ul class="movie-rating-percent">
                                                    <li>
                                                        <div class="thumb">
                                    ...
                                    <div class="col-sm-6 col-lg-4">
                                        <div class="movie-grid">
                                            ...
                                            <div class="movie-content bg-one">
                                                <h5 class="title m-0">
                                                    <a href="moviedetail">halloween party</a>
                                                </h5>
                                                <ul class="movie-rating-percent">
                                                    <li>
                                                        <div class="thumb">
                                    ...
                                    <div class="col-sm-6 col-lg-4">
                                        <div class="movie-grid">
                                            ...
                                            <div class="movie-content bg-one">
                                                <h5 class="title m-0">
                                                    <a href="moviedetail">the most wanted</a>
                                                </h5>
                                                <ul class="movie-rating-percent">
                                                    <li>
                                                        <div class="thumb">
                            ...
                            <div class="tab-item active">
                                <div class="movie-area mb-10">
                                    <div class="movie-list">
                                        <div class="movie-thumb c-thumb">
                                            <a href="moviedetail" class="w-100 bg_img h-100" data-background="./assets/images/movie/movie01.jpg">
                                                ...
                                                <div class="book-ticket">
                                                    ...
                                                    <div class="react-item">
                                                        <a href="#0" class="popup-video">
                                                            ...
                                                            <span><video src="https://www.youtube.com/watch?v=N0L8JPwwblY"> watch trailer</video></span>
                                                        </a>
                                                    </div>
                                                </div>
                                            </div>
                                    ...
                                    <div class="movie-list">
                                        <div class="movie-thumb c-thumb">
                                            <a href="moviedetail" class="w-100 bg_img h-100" data-background="./assets/images/movie/movie02.jpg">
                                    ...
                                    <div class="movie-list">
                                        <div class="movie-thumb c-thumb">
                                            <a href="moviedetail" class="w-100 bg_img h-100" data-background="./assets/images/movie/movie03.jpg">
                                    ...
                                    <div class="movie-list">
                                        <div class="movie-thumb c-thumb">
                                            <a href="moviedetail" class="w-100 bg_img h-100" data-background="./assets/images/movie/movie04.jpg">
                                    ...
                                    <div class="movie-list">
                                        <div class="movie-thumb c-thumb">
                                            <a href="moviedetail" class="w-100 bg_img h-100" data-background="./assets/images/movie/movie05.jpg">
                                    ...
                                    <div class="movie-list">
                                        <div class="movie-thumb c-thumb">
                                            <a href="moviedetail" class="w-100 bg_img h-100" data-background="./assets/images/movie/movie06.jpg">
                                    ...
                                    <div class="movie-list">
                                        <div class="movie-thumb c-thumb">
                                            <a href="moviedetail" class="w-100 bg_img h-100" data-background="./assets/images/movie/movie07.jpg">
                                    ...
                                    <div class="movie-list">
                                        <div class="movie-thumb c-thumb">
                                            <a href="moviedetail" class="w-100 bg_img h-100" data-background="./assets/images/movie/movie08.jpg">
                                    ...
                                    <div class="movie-list">
                                        <div class="movie-thumb c-thumb">
                                            <a href="moviedetail" class="w-100 bg_img h-100" data-background="./assets/images/movie/movie09.jpg">
                                    ...
                                    <div class="movie-list">
                                        <div class="movie-thumb c-thumb">
                                            <a href="moviedetail" class="w-100 bg_img h-100" data-background="./assets/images/movie/movie10.jpg">
                                    ...
                                    <div class="movie-list">
                                        <div class="movie-thumb c-thumb">
                                            <a href="moviedetail" class="w-100 bg_img h-100" data-background="./assets/images/movie/movie11.jpg">
                                    ...
                                    <div class="movie-list">
                                        <div class="movie-thumb c-thumb">
                                            <a href="moviedetail" class="w-100 bg_img h-100" data-background="./assets/images/movie/movie12.jpg">
