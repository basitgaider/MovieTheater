                ...
                <div class="col-lg-6">
                    <div class="event-about-content">
                        <div class="section-header-3 left-style m-0">
                            <span class="cate">we are Movie Theater </span>
                            <h2 class="title">Get to know us</h2>
                            <p>
                            Welcome to our Movie Theater, where cinematic experiences come to life! We are passionate about creating a space where movie enthusiasts, like yourself, can immerse in the magic of storytelling on the big screen. Here's a glimpse into who we are and what drives our love for movies:</p>
                            <p>
                            Our Mission At Movie Theater
                            The Team
                            Meet the faces behind the scenes a dedicated team of movie aficionados who work tirelessly to curate an exceptional selection of films. From timeless classics to the latest blockbusters, we're here to ensure that your movie-going experience is nothing short of extraordinary.
                            Our Cinematic Vision
                            We envision Movie Theater as more than just a place to watch movies; it's a community hub for film enthusiasts. From hosting special screenings to organizing events that celebrate the art of filmmaking, we strive to foster a love for cinema in every corner of our community.</p>
                ...
                <div class="col-lg-9 offset-lg-3 bg-two">
                    <div class="philosophy-content">
                        <div class="section-header-3 left-style">
                            ...
                            <p class="ml-0">
                            our mission is to provide an unparalleled cinematic journey for every visitor. We believe in the power of storytelling and its ability to inspire, entertain, and transport audiences to different worlds. </p>
                        </div>
